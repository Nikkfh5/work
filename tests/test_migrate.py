...
def test_apply_migrations_adds_columns_to_tasks(fresh_db):
    ...
    expected_columns = {
        ...
        "worker_attempt", "review_iteration",
        "last_error_code", "last_error_reason",
        "notion_page_url", "partial_result",
    }
...
def test_task_runs_table_structure(fresh_db):
    ...
    expected = {
        "id", "task_id", "phase", "attempt",
        "started_at", "finished_at", "returncode",
        "stdout_path", "stderr_path", "parsed_json", "json_valid",
    }
