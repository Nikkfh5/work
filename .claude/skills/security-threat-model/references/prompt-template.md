...
Represent the system as a sequence of arrow-style bullets. For each boundary, document:
...
#### Diagram
- Include a single, compact Mermaid diagram showing primary components and trust boundaries.
